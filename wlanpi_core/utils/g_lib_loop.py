...
class GLibLoop:
    ...
    def __init__(self, loop: Optional[GLib.MainLoop]=None, timeout_seconds: Optional[int]=None, timeout_callback: Optional[callable]=None, timeout_callback_args: Optional[list]=None, timeout_callback_kwargs:Optional[dict]=None):
    ...
    def start_timeout(self, seconds: Optional[int]=None, callback: Optional[callable]=None, *args, **kwargs):
        self.timeout_source = GLib.timeout_source_new_seconds(seconds if seconds else self.timeout_seconds)
        ...
        self.timeout_source_attachment = self.timeout_source.attach(self.loop.get_context())
