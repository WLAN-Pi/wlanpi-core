...
from wlanpi_core.schemas.network_config import network_config, NetworkConfigResponse
...
@router.get("/ethernet/all/vlans", response_model=dict[str, list[IPInterface]])
...
@router.post("/ethernet/{interface}/vlan/{vlan}", response_model=network_config.NetworkConfigResponse)
...
@router.delete("/ethernet/{interface}/vlan/{vlan}", response_model=network_config.NetworkConfigResponse)
